...
{  
        ...
        static Dictionary<string, bool> _stops = new Dictionary<string, bool>
    {
        ...
        public static Dictionary<string, int> RemoveStopwordsAndGetCount(string input)
        {
            ...
            {
                string lowercase = currentWord.ToLower();
                if (!_stops.ContainsKey(lowercase))
                {
                    if (!wordCounts.ContainsKey(lowercase))
                    {
                        wordCounts.Add(lowercase, 1);
                        continue;
                    }
                    wordCounts[lowercase] = ++wordCounts[lowercase];
                }
            }
            return wordCounts;
        }
